...
public class MindustryGenerators {
    ...
    protected static float fluid(boolean gas, double x, double y, float frame) {
        ...
        if (gas) {
            ...
            // Mathf.lerp((float)liquidFrame(rx, ry, curFrame), (float)liquidFrame(rx, ry, nextFrame), progress);
    ...
    protected static double gasFrame(double x, double y, int frame) {
        int s = 31;
    ...
    protected static double liquidFrame(double x, double y, int frame) {
        int s = 31;
        // calculate random space offsets for the frame cutout
    ...
    protected void run() {
        ...
        generate("gas-frames", this::gasFrames);
    ...
    protected boolean generateGasFrames;

    protected void gasFrames() {
        if (!generateGasFrames)
            return;
