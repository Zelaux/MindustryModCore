...
//            Draw.z(z);
        ...
        public void draw(){
            ...
            Draw.draw(Layer.flyingUnit + 4, () -> {
                ...
                ADrawText.drawText(x + Tmp.v1.x, y + Tmp.v1.y, Pal.heal, String.valueOf(dstTileToTarget()));
                drawTiles(xtiles);
                drawTiles(ytiles);
            });
        ...
        protected void drawTiles(Seq<Tile> tiles){
            if(tiles.size > 2){
                ...
                ADrawText.drawText(tile.worldx(), tile.worldy(), Pal.heal, String.valueOf(tiles.size - 2));
            }
        }
