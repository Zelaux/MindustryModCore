...
@SupportedAnnotationTypes("mma.local.annotations.LocalAnnotations.LocalAnnotation")
public class SettingsEnumProcessor extends LocalBaseProcessor{
    @Override
    public void process(RoundEnvironment env) throws Exception{
        Stype stype = new Stype((TypeElement)Seq.with(env.getRootElements()).find(it -> it.toString().equals("mma.annotations.ModAnnotations")));
